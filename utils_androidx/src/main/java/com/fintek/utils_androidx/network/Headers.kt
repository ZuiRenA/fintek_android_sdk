...
import com.fintek.utils_androidx.network.internal.format
import com.fintek.utils_androidx.network.internal.toHttpDateOrNull
import com.fintek.utils_androidx.network.internal.toHttpDateString
...
class Headers private constructor(
    ...
    class Builder {
        ...
        fun add(name: String, value: Date) = apply {
            val valueStr = value.toHttpDateString()
            add(name, valueStr)
        }
