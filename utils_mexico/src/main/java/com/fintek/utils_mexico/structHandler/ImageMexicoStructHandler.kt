...
import com.fintek.utils_androidx.image.IImageStruct
import com.fintek.utils_mexico.model.ImageInfo
import java.io.File

/**
 * Created by ChaoShen on 2021/4/19
 */
class ImageMexicoStructHandler(
    ...
    override fun structHandler(attributes: SparseArrayCompat<String>): ImageInfo {
        ...
        struct.apply {
            ...
            date = attributes.get(ExifInterface.TAG_DATETIME.paramIndex()).orEmpty()
        }
